...
type FoodRepository interface {
	...
	InsertBuyFood(Did int, Food *models.Food) (int64, error)
}
type FoodDB struct {
	db *gorm.DB
}

// InsertBuyFood implements FoodRepository.
func (f FoodDB) InsertBuyFood(Did int, Food *models.Food) (int64, error) {
	num := 0
	day := []int{Did}
